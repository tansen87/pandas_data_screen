...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_merge_data = QtWidgets.QPushButton(self.frame_2)
        self.btn_merge_data.setMinimumSize(QtCore.QSize(80, 80))
        self.btn_merge_data.setMaximumSize(QtCore.QSize(80, 80))
        self.btn_merge_data.setStyleSheet("QPushButton {\n"
                                          "    background-color: rgb(170, 170, 255);\n"
                                          "    color: #FFFFFF;\n"
                                          "    border-radius: 40px;\n"
                                          "    border-style: outset;\n"
                                          ...
                                          "    background-color: lightgreen;\n"
                                          "}")
        self.btn_merge_data.setText("")
        self.btn_merge_data.setObjectName("btn_merge_data")
        self.verticalLayout.addWidget(self.btn_merge_data)
